...
MODEL_PATH = 'google_results/models/103/6/model_at_epoch_1000.pt'
...
def do_single_states(test, output_dir, params, model=None):
    ...
    for t in tqdm(ts):
        ...
        # print(((real_soln - real_truth[0,:])**2 + (imag_soln - imag_truth[0,:])**2).shape)

        # print('SHAPE 1')
        # print(real_soln.shape)

        # print('sahep 2')
        # print(real_truth[0,:].shape)
...
def get_arguments():
    ...
    parser.add_argument('--MODEL', type=str, nargs=1, default=MODEL_PATH,
                        help='Model file to use.')
    parser.add_argument('--MODEL_MAX_TIME', type=float, nargs='?', default=0.4,
...
def check_arguments(args):
    ...
    check_args_positive_numbers(args, ['SIM_MAX_TIME', 'MODEL_MAX_TIME'])
...
def main():
    ...
    do_single_states(test, output_directory, params, model)
