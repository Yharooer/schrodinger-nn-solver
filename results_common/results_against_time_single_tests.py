...
def get_tests():
    ...
    tests.add('particle_in_box_eigen2', lambda x: np.sqrt(2)*np.sin(2*np.pi*x), lambda x: 0*x, lambda x: 0*x, lambda x,t: np.sqrt(2)*np.sin(2*np.pi*x)*np.cos((0.5 * 4 * np.pi**2)*t), lambda x,t: np.sqrt(2)*np.sin(2*np.pi*x)*np.sin(-(0.5 * 4 * np.pi**2)*t))
    tests.add('particle_in_box_eigen3', lambda x: np.sqrt(2)*np.sin(3*np.pi*x), lambda x: 0*x, lambda x: 0*x, lambda x,t: np.sqrt(2)*np.sin(3*np.pi*x)*np.cos((0.5 * 9 * np.pi**2)*t), lambda x,t: np.sqrt(2)*np.sin(3*np.pi*x)*np.sin(-(0.5 * 9 * np.pi**2)*t))
    tests.add('particle_in_box_eigen4', lambda x: np.sqrt(2)*np.sin(4*np.pi*x), lambda x: 0*x, lambda x: 0*x, lambda x,t: np.sqrt(2)*np.sin(4*np.pi*x)*np.cos((0.5 * 16 * np.pi**2)*t), lambda x,t: np.sqrt(2)*np.sin(4*np.pi*x)*np.sin(-(0.5 * 16 * np.pi**2)*t))
    tests.add('particle_in_box_eigen5', lambda x: np.sqrt(2)*np.sin(5*np.pi*x), lambda x: 0*x, lambda x: 0*x, lambda x,t: np.sqrt(2)*np.sin(5*np.pi*x)*np.cos((0.5 * 25 * np.pi**2)*t), lambda x,t: np.sqrt(2)*np.sin(5*np.pi*x)*np.sin(-(0.5 * 25 * np.pi**2)*t))
